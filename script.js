document.addEventListener("DOMContentLoaded", () => {
  ...
  // Não existe backend: nada é "enviado" a partir deste formulário.
  // O botão apenas gera um link https://wa.me/... com o texto digitado
  // e abre o WhatsApp (app ou web) para a própria pessoa enviar.
  // ======================================================
  ...
  if (contactForm) {
    if (whatsappNumber.length < 12) {
      ...
      if (contactFormStatus) {
        contactFormStatus.textContent =
          "O WhatsApp ainda não foi configurado (config.js), então o formulário está desativado.";
      }
    }
    ...
    contactForm.addEventListener("submit", (event) => {
      ...
      if (whatsappNumber.length < 12) return;
      ...
      if (nome) partesMensagem.push(`Olá, Guilherme! Meu nome é ${nome}.`);
      partesMensagem.push(mensagemDigitada || whatsappMessage);
      ...
      if (contactFormStatus) {
        contactFormStatus.textContent =
          "Abrindo o WhatsApp com sua mensagem — confira e toque em enviar por lá.";
      }
